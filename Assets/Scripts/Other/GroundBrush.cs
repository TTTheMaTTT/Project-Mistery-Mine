...
public class GroundBrush : ScriptableObject
{
    ...
    {
        return (defGround == _sprite) || (outGround == _sprite) || (inAngleGround == _sprite) || (outAngleGround == _sprite) || 
                (edgeGround == _sprite) || (marginGround == _sprite) || (inGround == _sprite) || (angleGround == _sprite);
    }
